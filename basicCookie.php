...
// }
			...
			//
			// }
				// $p=$this->app->input->cookie->get('rishabh',null);
// 			if (!$p)
// 			{
// 				// $cookieName = 'joomla_' . UserHelper::getShortHashedUserAgent();
// $this->app->input->cookie->set('rishabh'.UserHelper::getShortHashedUserAgent(),'value');
//
// 				// Check for the cookie
//
